...
async function getPostData(slug: string) {
  ...
  // 去除正文开头的 # Title（页面 header 已显示标题，避免重复）
              ...
              <div className="relative">
                <style>{`
                  ...
                  @media (min-width: 768px) {
                    ...
                    .prose th, .prose td { padding: 12px 20px !important; font-size: 0.95rem !important; }
                    .prose th { font-size: 0.85rem !important; }
                  }
                `}</style>
