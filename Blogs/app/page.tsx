...
export default function Home() {
  ...
  const top5Chatters = allChatters.length > 0 ? allChatters.slice(0, 5) : [{ slug: 'none', title: '暂无记录', description: '记录一段思绪...', cover: 'https://bu.dusays.com/2026/06/24/6a3b9c5229fb1.png', date: '', formattedDate: '' }];
  ...
  try {
    if (fs.existsSync(momentsDirectory)) {
      momentsCount = fs.readdirSync(momentsDirectory).filter(f => f.endsWith('.md')).length;
    }
  } catch (e) {}
            ...
            <main className="flex flex-col gap-6 w-full mt-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full">
                ...
                <div className="col-span-1 lg:col-span-7 flex flex-col">
                    <ProfileCard postCount={allPosts.length} chatterCount={chatterCount} momentsCount={momentsCount} photoCount={realPhotoCount}/>
                </div>
                {/* 手机上占满1列，电脑上占5列 */}
